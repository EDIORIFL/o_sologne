 ...
 * SupportType
 *
 * @ORM\Entity(repositoryClass="App\Repository\SupportTypeRepository")
 * @ORM\Table(name="support_type", uniqueConstraints={@ORM\UniqueConstraint(name="UNIQ_54C8C17AEA750E8", columns={"label"})})
 */
class SupportType
{
    /**
